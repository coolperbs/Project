  ...
  <router-link :to="{ path : '/orders/detail' }" class="order">
    ...
    <ul class="list">
      ...
      <li>
        ...
        <div class="value">2018-8-1 12:00</div>
      </li>
      <li>
        <div class="key">orderprice :</div>
        <div class="value">$10.00</div>
      </li>
      <li>
        <div class="key">recordback :</div>
        <div class="value">$10.00</div>
      </li>
      <li>
...
<style scoped>
    ...
    .list { border-top : dashed 1px #f0f0f0; margin-top : 10px; }
    .list li { padding : 0 10px 0 70px; height : 30px; line-height: 30px; }
