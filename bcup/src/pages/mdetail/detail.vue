<template>
  <div class="detail">
   ...
   <router-link 
      :to="{ path : '/checkout', query : { skuId : checkedSkuId, paytype : 2 } }"
      class="buy">
      余额购买
    </router-link>
  </div>
...
<style scoped>
  .buy { display : block; height : 44px; position: fixed; bottom : 0; left : 0; width: 100%; display: flex; justify-content: center; align-items: center; color : #fff; background-color: #ff6e1d; font-size : 16px; }
  .detail {
