...
<style scoped>
    ...
    .home { width : 44px; height : 44px; float : left; margin-left : -44px; text-align: center; border-right : solid 1px #dfdfdf; }
    .cont .btn { height : 100%; width : 50%; display: inline-block; float : left; text-align: center; }
    .cont .btn.primary { background-color : #efefef; transition : all 0.5s; }
    ...
    .pop .list .item { background-color: #fff; border-bottom : solid 1px #f0f0f0; padding : 0 10px; height : 60px; line-height: 60px; }
