...
function parseDependencies(s) {
  if(s.indexOf('require') == -1 || window.closeSeajsRequire ) {
    return []
  }
  ...
  s.replace(commentRegExp, '').replace(cjsRequireRegExp, function (match, dep) { res.push(dep); });
  window.globalTime = window.globalTime || 0;
  window.globalTime += ( new Date().getTime() - startTime );
  return res;
  /*=================== new parse End ==================*/
