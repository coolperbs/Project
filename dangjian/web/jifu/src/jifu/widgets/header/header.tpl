<div class="w-w-header">
	...
	<script class="J_HMainTemp" type="text/html">
		<div class="logo" style="-webkit-app-region:drag;">
			<img src="jifu/src/jifu/widgets/header/images/logo.png"/>
		</div>
		<!--
		<div class="info">
		...
		<div class="act">
			<div class="head">
				<div class="back J_Back">
					<img src="./jifu/src/jifu/widgets/header/images/back.png"/>
				</div>
		...
		<% if ( search ) { %>
			<div class="search">
				...
				<div class="btn J_Search">
					<img src="./jifu/src/jifu/widgets/header/images/search.png"/>
				</div>
			</div>		
		<% } %>
	</script>
