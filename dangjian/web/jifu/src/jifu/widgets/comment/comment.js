define('jifu/widgets/comment/comment', function (require, exports, module) {
    require( 'jifu/widgets/comment/comment.tpl' );
    require( 'jifu/widgets/comment/comment.css' );
    var handle, _fn,
        DEFAULT_OPT,
        kDom = kayak.dom,
        ...
        cookie = require( 'jifu/common/cookie/cookie' ),
    ...
    _fn = {
        ...
        bind : function() {
            ...
            jView.on( 'click', '.J_Btn', function( e ) {
                var value = jView.find( '.J_Text' ).val( );
                if ( handle.callback ) {
