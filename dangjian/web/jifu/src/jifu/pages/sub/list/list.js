define( 'jifu/pages/sub/list/list', function( require, exports, module ) {
	require( 'jifu/pages/sub/list/list.tpl' );
	require( 'jifu/pages/sub/list/list.css' );
	...
	var handle, CFG, _fn, kayak, kDom, DOM_EVENT, userServices, router,
		...
		pPop = require( 'jifu/widgets/projectpop/projectpop' ),
