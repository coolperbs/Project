define('wuhou/widgets/comment/comment', function (require, exports, module) {
    require( 'wuhou/widgets/comment/comment.tpl' );
    require( 'wuhou/widgets/comment/comment.css' );
    var handle, _fn,
        DEFAULT_OPT,
        kDom = kayak.dom,
