define( 'wuhou/pages/analysis/analysis', function( require, exports, module ) {
	require( 'wuhou/pages/analysis/analysis.css' );
	require( 'wuhou/pages/analysis/analysis.tpl' );
