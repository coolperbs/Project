define( 'wuhou/pages/news/news', function( require, exports, module ) {
	require( 'wuhou/pages/news/news.css' );
	require( 'wuhou/pages/news/news.tpl' );
	var handle, CFG, _fn, kayak, DOM_EVENT, userServices,
        ...
        isLoading = false,
		header = require( 'wuhou/widgets/header/header' ), searchKey = '',
