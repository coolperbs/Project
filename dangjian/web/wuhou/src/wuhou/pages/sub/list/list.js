define( 'wuhou/pages/sub/list/list', function( require, exports, module ) {
	require( 'wuhou/pages/sub/list/list.tpl' );
	require( 'wuhou/pages/sub/list/list.css' );
	...
	var handle, CFG, _fn, kayak, kDom, DOM_EVENT, userServices, router,
		...
		pPop = require( 'wuhou/widgets/projectpop/projectpop' ),
		login = require( 'wuhou/widgets/login/login' ),
		header = require( 'wuhou/widgets/header/header' ),
		comment = require( 'wuhou/widgets/comment/comment' ),
