define( 'wuhou/pages/sub/create/create', function( require, exports, module ) {
	require( 'wuhou/pages/sub/create/create.tpl' );
	require( 'wuhou/pages/sub/create/create.css' );
