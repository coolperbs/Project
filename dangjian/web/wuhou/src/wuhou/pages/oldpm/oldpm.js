define( 'wuhou/pages/oldpm/oldpm', function( require, exports, module ) {
	require( 'wuhou/pages/oldpm/oldpm.css' );
	require( 'wuhou/pages/oldpm/oldpm.tpl' );
	...
	handle = {
        ...
        on : {
        	'click .J_Link' : function( e ) {
        		var jTarget = $( this );
        		kayak.router.go( '#index/wuhou/oldpm:url=' + encodeURIComponent( jTarget.attr( 'data-url' ) ) );
        	}
        }
	}
	// 其他依赖资源预加载
