define( 'wuhou/pages/links/links', function( require, exports, module ) {
	require( 'wuhou/pages/links/links.css' );
	require( 'wuhou/pages/links/links.tpl' );
	...
	handle = {
        ...
        on : {
        	'click .J_Link' : function( e ) {
        		var jTarget = $( this );
        		kayak.router.go( '#index/wuhou/links:url=' + encodeURIComponent( jTarget.attr( 'data-url' ) ) );
        	}
        }
	}
	// 其他依赖资源预加载
