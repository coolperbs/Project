define( 'tongzilin/pages/ndetail/ndetail', function( require, exports, module ) {
	require( 'tongzilin/pages/ndetail/ndetail.css' );
	require( 'tongzilin/pages/ndetail/ndetail.tpl' );
