define( 'tongzilin/pages/sub/apply/apply', function( require, exports, module ) {
	require( 'tongzilin/pages/sub/apply/apply.tpl' );
	require( 'tongzilin/pages/sub/apply/apply.css' );
