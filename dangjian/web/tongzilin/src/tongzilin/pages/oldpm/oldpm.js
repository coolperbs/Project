define( 'tongzilin/pages/oldpm/oldpm', function( require, exports, module ) {
	require( 'tongzilin/pages/oldpm/oldpm.css' );
	require( 'tongzilin/pages/oldpm/oldpm.tpl' );
	...
	handle = {
        ...
        on : {
        	'click .J_Link' : function( e ) {
        		var jTarget = $( this );
        		kayak.router.go( '#index/tongzilin/oldpm:url=' + encodeURIComponent( jTarget.attr( 'data-url' ) ) );
        	}
        }
	}
	// 其他依赖资源预加载
