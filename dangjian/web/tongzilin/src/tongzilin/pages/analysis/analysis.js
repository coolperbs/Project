define( 'tongzilin/pages/analysis/analysis', function( require, exports, module ) {
	require( 'tongzilin/pages/analysis/analysis.css' );
	require( 'tongzilin/pages/analysis/analysis.tpl' );
