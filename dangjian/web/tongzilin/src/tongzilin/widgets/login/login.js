define('tongzilin/widgets/login/login', function (require, exports, module) {
    require( 'tongzilin/widgets/login/login.tpl' );
    require( 'tongzilin/widgets/login/login.css' );
    var handle, _fn,
        DEFAULT_OPT,
        kDom = kayak.dom,
