define('tongzilin/widgets/comment/comment', function (require, exports, module) {
    require( 'tongzilin/widgets/comment/comment.tpl' );
    require( 'tongzilin/widgets/comment/comment.css' );
    var handle, _fn,
        DEFAULT_OPT,
        kDom = kayak.dom,
