...
(function ($, window) {
    define('cabin/common/widgets/dmFromValidate', function (require, exports, module) {
        ;
        ...
        +function ($) {
            ...
            Validator.prototype.bind = function () {
                $(this.element).on('change.dm.validate', '[data-valid]', $.proxy(this.validateRules, this)).on('input.dm.validate', '[data-valid]', $.proxy(this.validateRules, this)).on('propertychange.dm.validate', '[data-valid]', $.proxy(this.validateRules, this))
            };
            Validator.prototype.showMsg = function () {
                ...
                _d.appendChild(_p);
                if (this.type == 'pop') {
                    $(this.$element).on('mouseover.dm.validate', function () {
            ...
            Validator.prototype.submitValid = function () {
                var that = this;
                var isValid = true;
                $(that.element).find('[data-valid]:not([type="hidden"])').each(function () {
