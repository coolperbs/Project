...
var _fn = {
	...
	initSortWeiget: function (page) {
		page.sortMenu = new SortMenu({
			data: [{ text: '销量', key: 'saleSort' }, { text: '价格', key: 'priceSort' }, { text: '日期', key: 'publishSort' }]
		});
