...
var _fn = {
	init: function (page) {
		...
		if (page.aftersaleItem) {
			fileList = [page.aftersaleItem.aftersale.img1, page.aftersaleItem.aftersale.img2, page.aftersaleItem.aftersale.img3, page.aftersaleItem.aftersale.img4, page.aftersaleItem.aftersale.img5, page.aftersaleItem.aftersale.img6, page.aftersaleItem.aftersale.img7, page.aftersaleItem.aftersale.img8];
		}
